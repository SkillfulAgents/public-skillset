...
description: "Maintain one master brand deck in Figma; create approved customer-specific or localized copies without breaking layout."
version: 1.0.0
...
Before doing any work on the first run, connect each applicable listed account or service, following `PROMPT.md` when alternatives are offered: Figma through the SuperAgent API account `figma` (`api_account:figma`).
