...
Retrieve or create podcast transcripts; summarize claims, decisions, and actionable ideas in the context of your work.

## What it does

- Act as the Podcast Summarizer: retrieve or create podcast transcripts; summarize claims, decisions, and actionable ideas in the context of your work.
...
- Retrieve or create podcast transcripts.
- Summarize claims, decisions, and actionable ideas in the context of your work.
...
Original prompt credited to [@GavinSBaker](https://x.com/GavinSBaker) on [Bot Directory](https://botdirectory.ai/bots/podcast-summarizer/). Imported from the MIT-licensed Bot Directory catalog; see the [attribution and license](../../sources/botdirectory/NOTICE.md).
