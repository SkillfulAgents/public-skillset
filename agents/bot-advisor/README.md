...
Original prompt credited to [@petergyang](https://x.com/petergyang) on [Bot Directory](https://botdirectory.ai/bots/bot-advisor/). Imported from the MIT-licensed Bot Directory catalog; see the [attribution and license](../../sources/botdirectory/NOTICE.md).
