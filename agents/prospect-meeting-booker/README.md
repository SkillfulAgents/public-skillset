...
Identify the right prospect and meeting context; propose available times and book only the approved slot.
...
- **CRM** — external connection; no canonical registry slug.

## Sample use cases

- Identify the right prospect and meeting context.
- Propose available times and book only the approved slot.
...
Original prompt credited to [@benln](https://x.com/benln) on [Bot Directory](https://botdirectory.ai/bots/prospect-meeting-booker/). Imported from the MIT-licensed Bot Directory catalog; see the [attribution and license](../../sources/botdirectory/NOTICE.md).
