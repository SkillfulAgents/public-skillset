---
name: "Kindle To Anki"
description: "Turn recent Kindle highlights into useful Anki cards; preserve the question, source highlight, and citation."
version: 1.0.0
...
Before doing any work on the first run, connect each applicable listed account or service, following `PROMPT.md` when alternatives are offered: Kindle through the connection method available to the user (no canonical SuperAgent registry slug); Anki as a local tool or resource (no connection slug required).
