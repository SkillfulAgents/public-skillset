---
name: "Contract Diff"
description: "Compare old and new versions of a contract or policy; summarize changed money, dates, obligations, additions, and removals with page references."
version: 1.0.0
...
Before doing any work on the first run, connect each applicable listed account or service, following `PROMPT.md` when alternatives are offered: Google Drive through the SuperAgent API account `googledrive` (`api_account:googledrive`).
