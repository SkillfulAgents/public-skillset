...
description: "Find public LinkedIn profiles that match a defined ICP; capture qualified prospects with roles, companies, links, and evidence."
version: 1.0.0
...
Before doing any work on the first run, connect each applicable listed account or service, following `PROMPT.md` when alternatives are offered: Google Search as a built-in capability (no connection slug required).
