...
Combine family calendars, school schedules, grades, and messages; identify follow-ups and prepare a useful household update.
...
- Combine family calendars, school schedules, grades, and messages.
- Identify follow-ups and prepare a useful household update.
...
Original prompt credited to [@mrfundman](https://x.com/mrfundman) on [Bot Directory](https://botdirectory.ai/bots/household-coordinator/). Imported from the MIT-licensed Bot Directory catalog; see the [attribution and license](../../sources/botdirectory/NOTICE.md).
